...
contract X402AccessManager {
    ...
    event RentalGranted(address indexed user, uint256 indexed contentId, uint256 daysRented, uint256 expiresAt);
    ...
    constructor(address _creatorHub, address _usdc, address _paymentVerifier) {
